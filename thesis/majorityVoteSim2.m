function result = majorityVoteSim2(links, resultsfilename, axismode, elitepower, commonpower, rounds, graphname)
...
for e = elitepower
	for c = commonpower
		temp = playVotingGame(links, elite_size, n, e, c, rounds, 'monopoly');
		elite_size = temp(1,1);
		dislikes = temp(1,2);
		neutral = temp(1,3);
		likes = temp(1,4);
